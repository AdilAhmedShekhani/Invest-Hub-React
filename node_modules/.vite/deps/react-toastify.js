...
function C(t2) {
  ...
  function L2(t3, n2) {
    ...
    if (!f(t3) || function(t4) {
      ...
      return;
    const { toastId: l3, updateId: c2, data: T3 } = i2, { props: I3 } = C2, L3 = () => b2(l3), N2 = null == c2;
    N2 && C2.count++;
    const M2 = { ...I3, style: I3.toastStyle, key: C2.toastKey++, ...i2, toastId: l3, updateId: c2, data: T3, closeToast: L3, isIn: false, className: m(i2.className || I3.toastClassName), bodyClassName: m(i2.bodyClassName || I3.bodyClassName), progressClassName: m(i2.progressClassName || I3.progressClassName), autoClose: !i2.isLoading && (R2 = i2.autoClose, w2 = I3.autoClose, false === R2 || u(R2) && R2 > 0 ? R2 : w2), deleteToast() {
    ...
    let x2 = t3;
    (0, import_react.isValidElement)(t3) && !d(t3.type) ? x2 = (0, import_react.cloneElement)(t3, { closeToast: L3, toastProps: M2, data: T3 }) : p(t3) && (x2 = t3({ closeToast: L3, toastProps: M2, data: T3 })), I3.limit && I3.limit > 0 && C2.count > I3.limit && N2 ? C2.queue.push({ toastContent: x2, toastProps: M2, staleId: r3 }) : u(s2) ? setTimeout(() => {
      O2(x2, M2, r3);
    }, s2) : O2(x2, M2, r3);
  }
  ...
  return (0, import_react.useEffect)(() => (C2.containerId = t2.containerId, v.cancelEmit(3).on(0, L2).on(1, (t3) => g2.current && b2(t3)).on(5, I2).emit(2, C2), () => {
...
Q.loading = (t2, e2) => H(t2, S("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...e2 })), Q.promise = function(t2, e2, n2) {
  ...
  const i2 = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null, delay: 100 }, l2 = (t3, e3, s3) => {
    if (null == e3)
  ...
  void 0 === e2 && (e2 = {}), setTimeout(() => {
    ...
    if (n2) {
      const { props: o2, content: s2 } = n2, a2 = { ...o2, ...e2, toastId: e2.toastId || t2, updateId: z() };
